...
function App() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => openModal()}
        className="fixed bottom-5 right-5 bg-green-500 hover:bg-green-600 p-4 rounded-full shadow-lg z-50 text-white text-2xl flex items-center justify-center whatsapp-pulse"
      >
        <FaWhatsapp />
      </button>
      ...
      {showLocationModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white/90 backdrop-blur-md rounded-2xl p-6 w-80 text-center shadow-2xl animate-fade-in">
            <h3 className="text-xl font-semibold mb-1">Select Location</h3>
            ...
            {selectedProduct && (
              <p className="text-xs text-blue-600 mb-4">{selectedProduct}</p>
            )}
