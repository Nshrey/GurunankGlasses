  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] md:w-[90%] max-w-7xl bg-white/80 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-lg z-50">
      <div className="flex justify-between items-center px-6 py-4">
        <div className="text-lg md:text-xl font-semibold text-gray-900 tracking-wide whitespace-nowrap">
        ...
        <button
          onClick={openModal}
          className="bg-white text-black px-5 py-2 rounded-xl hover:bg-gray-100 transition shadow-md"
        >
          Get Quote
        </button>
      </div>
